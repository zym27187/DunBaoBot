...
data = {
    'rsshub': 'http://rss.ireina.fun:1200',
    'proxy': 'http://xK3ZlCBjp9:jTpD1KKwn1@167.88.182.80:10922',
    'proxy_urls': ['http://xK3ZlCBjp9:jTpD1KKwn1@167.88.182.80:10922'],
    'last_time': {},
    'group_rss': {},
    'group_mode': {},
}
...
async def generate_image(url_list):
    ...
    for url in url_list:
        ...
        proxy = 'http://xK3ZlCBjp9:jTpD1KKwn1@167.88.182.80:10922'# 写死了
...
async def rss_add(group_id, rss_url):
    ...
    # data['proxy_urls']='http://xK3ZlCBjp9:jTpD1KKwn1@167.88.182.80:10922'
    proxy = ''
    for purl in data['proxy_urls']:
        if purl in rss_url:
            proxy = data['proxy']
