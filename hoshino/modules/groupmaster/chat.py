...
@on_command('zai?', aliases=('在吗', '在么？', '在嘛', '在嘛？'), only_to_me=True)
...
@sv.on_fullmatch('在?', '在？', only_to_me=True)
async def jiaonima(bot, ev):
    await bot.send(ev, R.img('jiaonima.jpg').cqcode)
